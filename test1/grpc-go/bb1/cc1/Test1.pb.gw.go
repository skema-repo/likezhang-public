...
/*
Package cc1 is a reverse proxy.
...
func RegisterTest1HandlerServer(ctx context.Context, mux *runtime.ServeMux, server Test1Server) error {
	...
	mux.Handle("GET", pattern_Test1_Heathcheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/bb1.cc1.Test1/Heathcheck", runtime.WithHTTPPathPattern("/api/healthcheck"))
		if err != nil {
	...
	mux.Handle("POST", pattern_Test1_Helloworld_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/bb1.cc1.Test1/Helloworld", runtime.WithHTTPPathPattern("/api/helloworld"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterTest1HandlerClient(ctx context.Context, mux *runtime.ServeMux, client Test1Client) error {
	...
	mux.Handle("GET", pattern_Test1_Heathcheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/bb1.cc1.Test1/Heathcheck", runtime.WithHTTPPathPattern("/api/healthcheck"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Test1_Helloworld_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/bb1.cc1.Test1/Helloworld", runtime.WithHTTPPathPattern("/api/helloworld"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
