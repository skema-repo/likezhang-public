...
func (c *test1Client) Heathcheck(ctx context.Context, in *HealthcheckRequest, opts ...grpc.CallOption) (*HealthcheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/Module1.Pack1.Test1/Heathcheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *test1Client) Helloworld(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/Module1.Pack1.Test1/Helloworld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Test1_Heathcheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Module1.Pack1.Test1/Heathcheck",
	}
...
func _Test1_Helloworld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Module1.Pack1.Test1/Helloworld",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Test1_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Module1.Pack1.Test1",
